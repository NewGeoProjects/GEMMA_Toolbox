...
if (length(pcs_to_plot)==2){ # Minimum 2 PCs
  ...
  pca_biplot_1 <- ggplot() +
    ...
    ggtitle(paste0(pcs_to_plot[1], " vs ", pcs_to_plot[2])) +
    # Species arrows
    geom_segment(data = rotation_df,aes(x = 0, y = 0, xend = x, yend = y),arrow = arrow(length = unit(0.2, "cm")), color = "orange",linewidth = 0.5) +
    # Species labels
  ...
  pca_biplot_2 <- ggplot() +
    ...
    # Species arrows
    geom_segment(data = rotation_df,aes(x = 0, y = 0, xend = x, yend = z),arrow = arrow(length = unit(0.2, "cm")), color = "orange",linewidth = 0.5) +
    # Species labels
  ...
  pca_biplot_3 <- ggplot() +
    ...
    # Species arrows
    geom_segment(data = rotation_df,aes(x = 0, y = 0, xend = y, yend = z),arrow = arrow(length = unit(0.2, "cm")), color = "orange",linewidth = 0.5) +
    # Species labels
